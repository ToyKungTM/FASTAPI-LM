...
def info():
    return {"service": "Depression Assessment Service", "version": "1.0"}

@router.patch("/status", tags=["Depression"])
def partial_update_depression_status(record_id: int, data: dict):
